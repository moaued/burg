...
public class InternalTransactionDraftPage {
  ...
  private By transactionLinkingTab = By.className("icon-tab7");
  private By transactionTypeInput = By.cssSelector("#ddlTypeId.form-control");
  private By circularOption = By.xpath("//ul[contains(@class,'ui-autocomplete')]//li[normalize-space()='تعميم']");

  //=============================================================
  //==============================SaveTransaction================
  private By saveInternalTransactionButton = By.id("btnSaveOutboundInternal");
  ...
  private By backToTheInboxButton = By.xpath(
      "//button[contains(@class,'redirect-to-tray') and contains(normalize-space(),'الرجوع')]");
  ...
  private By followupFirstOrgChartAutoSuggestion = By.cssSelector(
      "#divAutoComplateMenu div:nth-of-type(1)");
  private By followupEndDate = By.cssSelector(
      "input#AssignPaperFollowUpDateCal.is-calendarsPicker[name='ummalqura']");
  ...
  private By printQrPaperButton = By.xpath(
      "//button[contains(@class, 'btn-site') and contains(@class, 'barcode-button-popup')]");
  ;
  ...
  private By moveToBagButton = By.xpath(
      "//a[contains(@onclick,'openPendingExecution') and normalize-space()='نقل الى الحقيبة']"
  );
  private By holdCheckbox = By.xpath(
      "//input[@type='checkbox' and contains(@onchange,'holdDataFromBox')]"
  );
  private By sendButton = By.xpath("(//input[@id='btnSend'])[last()]");
  private By lastYesButton = By.xpath("(//button[normalize-space()='نعم'])[last()]");

  private By moveToBagButton2 = By.cssSelector(".text-center.hover-area");
  By luggageImagesAndCircularsTab = By.xpath("//span[normalize-space()='حقيبة الصور والتعاميم']");
//      By.cssSelector(".nav-item.active");

  //==================================================================================================================
  //====================================Link_Transaction========================================================
  private By addLinkButton = By.cssSelector("#btnLink.btn-site");
  private By yearDropdown = By.cssSelector("#ddlYear.form-control");
  private By linkedTransactionNumberField = By.cssSelector("#TransactionNumber.form-control");
 ...
 * */
  ...
  public InternalTransactionDraftPage(WebDriver driver) {
    this.driver = driver;
  }

  @Step("تغيير حالة ربط المعاملة")
  ...
  public InternalTransactionDraftPage addNewInternalTransaction() {
  ...
  public InternalTransactionDraftPage addRelevantperson() {
...
//                .click(sendSMSCheckBox)
  ...
  public InternalTransactionDraftPage saveInternalTransaction() {
    driver.element().scrollToElement(saveInternalTransactionButton)
        .click(saveInternalTransactionButton)
  ...
  public InternalTransactionDraftPage expandAttachmentSection() {
  ...
  @Step("اضافة ملحقات")
  public InternalTransactionDraftPage addAttachment(String transactionAttachmentType,
  ...
  public InternalTransactionDraftPage editFirstInTransaction() {
  ...
  private InternalTransactionDraftPage goToElectronicCopiesTab() {
  ...
  public InternalTransactionDraftPage addElectronicCopies(String orgUnitName, String orgUnitNumber,
      String copyReason) {
  ...
  public InternalTransactionDraftPage addFileToTransactionLetter(
  ...
  public InternalTransactionDraftPage modifyInTransactionSubject() {
  ...
  public InternalTransactionDraftPage saveModifiedTransaction2() {
    driver.element().scrollToElement(basicInfoTab).click(basicInfoTab);
...
//    driver.element()  .waitUntil(ElementsOperations.waitForElementToBeReady(saveModifiedTransactionButton));
  ...
  public InternalTransactionDraftPage addInGeneralTransactionDestination() {
...
//                .click(sendSMSCheckBox)
  ...
  public InternalTransactionDraftPage addInGeneralTransactionIndividual() {
...
//                .click(sendSMSCheckBox)
  ...
  @Step("حفظ معاملة ")
  public InternalTransactionDraftPage saveInTransaction() {
  ...
  private InternalTransactionDraftPage goToTransactionCopiesTab() {
    driver.element().click(transactionCopiesTab).verifyThat(orgnaisationalUnitNumber).isVisible();
    return this;
  }

  @Step("اضافة نسخ داخلية")
  public InternalTransactionDraftPage addInternalCopies(String orgUnitNum, String copyReason,
      int attachmentIndex) {
  ...
  public InternalTransactionDraftPage sendAndPrintDeliveryStatementForModifiedInTransaction() {
...
//        .click(saveModifiedTransactionButton);
  ...
  public InternalTransactionDraftPage printDeliveryStatementForAddedInTransaction() {
  ...
  public InternalTransactionDraftPage goToAttachmentsTab() {
  ...
  public InternalTransactionDraftPage printAssignmentPaperFromConfirmation() {
...
//        .waitUntil(ExpectedConditions.invisibilityOfElementLocated(loadingSpinner))
  ...
  public InternalTransactionDraftPage printQrPaperFromConfirmation() {
  ...
  public InternalTransactionDraftPage printBarcodeSticker() {
  ...
  public InternalTransactionDraftPage goToFollowupTab() {
  ...
  public InternalTransactionDraftPage addTransactionFollowup(String orgUnitNumber) {
    goToFollowupTab();
...
//        .type(remarks,"My remarks text");
  ...
  public InternalTransactionDraftPage goToAssignmentPaper() {
    driver.element().type(transactionSubjectTextField,
        "Transaction Description: " + modifiedTransactionDescription);
  ...
  public InternalTransactionDraftPage selectOrgUnitFromAssignmentPaper(String orgUnitName) {
  ...
  public InternalTransactionDraftPage sendAssignmentPaper() {
...
//        .verifyThat(sendAssignmentButton).doesNotExist().wait(5000);
  ...
  @Step("ارسال المعاملة الي الحقيبة")
  public InternalTransactionDraftPage sendluggage() {
    driver.element().scrollToElement(holdCheckbox)
        .click(holdCheckbox);
    driver.element().scrollToElement(moveToBagButton)
        .click(moveToBagButton);
    driver.element().click(sendButton)
        .waitUntil(ElementsOperations.waitForElementToBeReady(sendButton));
    driver.element().click(lastYesButton);
...
//        .verifyThat(sendAssignmentButton).doesNotExist().wait(5000);
  ...
  @Step("التحقق من ارسال المعاملة الي الحقيبة")
  public InternalTransactionDraftPage assertTransactionDisplayed(String transactionNumber) {
    By locator = By.xpath("//*[text()='" + transactionNumber + "']");
    driver.element()
...
//  @Step("إضافة ربط بمعاملة أخرى من تبويبة ربط المعاملات")
//  public InternalTransactionDraftPage addLinkedTransaction(String transactionNumber) {
//
//    driver.element().click(basicInfor)
//    ;
//
...
//  }
  ...
  @Step("تفعيل خيار ربط المعاملة من تبويب البيانات الأساسية")
  public InternalTransactionDraftPage enableTransactionLinking() {

    driver.element().click(basicInfoTab);

    boolean isChecked = driver.getDriver()
        .findElement(isLinkedTransactionCheckBox)
        .isSelected();
  ...
  @Step("الانتقال إلى تبويب ربط المعاملات")
  public InternalTransactionDraftPage goToTransactionLinkingTab() {

    driver.element()
        .click(transactionLinkingTab) // locator تبويب الربط
        .verifyThat(linkedTransactionNumberField)
        .isVisible();
  ...
  @Step("إضافة ربط معاملة داخلية بدون صلاحية")
  public InternalTransactionDraftPage addLinkedTransaction(
      String year,
      String transactionNumber) {

    driver.element().select(yearDropdown, year);

    driver.element().type(linkedTransactionNumberField, transactionNumber);

    driver.element().click(addLinkButton);

//    driver.element()
//        .verifyThat(linkedTransactionsGridRows)
//        .exists();

    return this;
  }

  @Step("اضافة معاملة داخلية جديدة  مع ربط ببمعاملة")
  public InternalTransactionDraftPage addNewInternalTransactionLink() {
    changeTransactionLinkStatus(true);
    //driver.element().click(isLinkedTransactionCheckBox);
    driver.element()
        .waitUntil(ElementsOperations.waitForElementToBeReady(transactionSubject))
        .type(transactionSubject, transactionSubjectText);
  ...
  @Step("ارسال المعاملة الي حقيبة حقيبة الصور والتعاميم")
  public InternalTransactionDraftPage sendImagesAndCircularsluggage() {
    driver.element().scrollToElement(holdCheckbox)
        .click(holdCheckbox);
    driver.element().scrollToElement(moveToBagButton2)
        .click(moveToBagButton2);

//    driver.element().click(luggageImagesAndCircularsTab);

//        .verifyThat(sendAssignmentButton).doesNotExist().wait(5000);
    return new InternalTransactionDraftPage(driver);
  }

  public InternalTransactionDraftPage navigateToImagesAndCircularsLuggage() {

    driver.element().click(luggageImagesAndCircularsTab)
        .waitUntil(ElementsOperations.waitForElementToBeReady(luggageImagesAndCircularsTab));
//    driver.element().click(luggageImagesAndCircularsTab);
  ...
  @Step("التحقق من ارسال المعاملة الي حقيبة الصور والتعاميم")
  public InternalTransactionDraftPage assertTransactionExistsInLuggage(String transactionNumber) {

    By transactionRow = By.xpath("//*[text()='" + transactionNumber + "']");
//        By.xpath("//tr[td[contains(text(),'" + transactionNumber + "')]]");

    driver.element()
        .waitUntil(ExpectedConditions.visibilityOfElementLocated(transactionRow));

    driver.element()
        .verifyThat(transactionRow)
        .exists();

    return this;
  }

  @Step("اضافة معاملة داخلية جديدة- نوع خطابها تعميم")
  public InternalTransactionDraftPage addNewInternalTransaction2() {
    changeTransactionLinkStatus(false);
