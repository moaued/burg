...
public class SentTransactionsReportPage extends ReportsNavigationPanelComponent {


  private By transactionTypeMenu = By.id("TransactionCategoryId");
  ...
  @Step("عرض التقرير")
  public SentTransactionsReportPage generateReportForTransactionType(
      String fromDate, String toDate, String selectedTransactionType) {
    driver.element().type(transactionTypeMenu,selectedTransactionType);
//    By option = By.xpath(
//        "(//div[contains(@class,'show')]//*[normalize-space()='"
//            + selectedTransactionType + "'])[1]"
//    );
////    driver.element().click(transactionTypeMenu);
//        driver.element().click(option);

//    driver.element().waitUntil(ElementsOperations.waitForElementToBeReady(selectedTransactionType)
//        .click(selectedTransactionType);

//  select(transactionTypeMenu, selectedTransactionType);
