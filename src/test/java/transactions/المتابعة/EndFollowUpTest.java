...
public class EndFollowUpTest extends TestBase {
...
//  }
  ...
  @Test(description = "[8.4] انهاء متابعة")
  @Description("[8.4] انهاء متابعة")
...
//    //Add 1 Attachments
    ...
    transactionsFollowupPage.endTransactionFollowUp().navigateToCompletedFollowUpTab();
    transactionsFollowupPage = transactionsFollowupPage.navigateToSentFollowUpTab()
        .getTransactionsOperationsComponent()
        .searchForTransactionWithId(transactionNumber, new TransactionsFollowupPage(driver));
    firstTransactionFollowupNumberOnCard = transactionsFollowupPage.navigateToCompletedFollowUpTab().getFirstTransactionNumber();
    Validations.verifyThat().object(firstTransactionFollowupNumberOnCard)
        .isEqualTo(transactionNumber);
