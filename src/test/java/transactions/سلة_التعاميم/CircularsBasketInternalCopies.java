...
public class CircularsBasketInternalCopies extends TestBase {
...
// =========================
  ...
  @Test(description = " بعد الدخول على النسخة من ايقونة العرض، التحقق من إمكانية إضافة نسخة جديدة لادارة من خلال تبيوبة النسخ الالكترونية الداخلية مع إضافة عنوان ومرفقات و ارشفة خاصة بها، والتحقق من وصولها للإدارة المرسل لها[15.2]")
  @Description("بعد الدخول على نسخة التعاميم من أيقونة العرض، التحقق من إمكانية إضافة نسخة جديدة لإدارة من خلال تبويبة النسخ الداخلية، مع مرفقات وأرشفة، والتحقق من وصولها للإدارة المرسل لها - سلة التعاميم[15.2]")
  public void sendCircularCopyUsingInternalCopies() {
