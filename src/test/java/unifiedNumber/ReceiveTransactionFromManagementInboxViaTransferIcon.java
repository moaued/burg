...
public class ReceiveTransactionFromManagementInboxViaTransferIcon extends TestBase {
...
//    }
  ...
  @Test(description = "التحقق من إمكانية استلام معاملة وفتحها للتعديل عبر أيقونة التحويل[9.8]")
  @Description("التحقق من إمكانية استلام معاملة وفتحها في التعديل من خلال ايقونة التحويل اذا كانت المعاملة الاصل في استقبال إدارة المستخدم[9.8]")
  public void receiveTransactionViaTransferIcon() {
